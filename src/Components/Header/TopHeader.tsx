...
const TopHeader : React.FC = () => {
  return (
    <div className=" hidden xl:flex bg-linear-to-l from-amber-600 to-blue-950 px-10 py-3 text-white  justify-around md:flex items-center">
      <div className="flex gap-10 px-3 py-1  ">
        <a href="">
